...
switch (_var) do
{
	...
	case "life_inv_wood": {(localize "STR_Item_TreeLog")};
	case "life_inv_woodplank": {(localize "STR_Item_Woodplank")};
	...
	case "license_civ_blackMarket": {(localize "STR_License_BlackMarket")};	
	...
	case "license_reb_coke": {(localize "STR_License_Cocaine")};
	case "license_reb_marijuana": {(localize "STR_License_Marijuana")};
	case "license_reb_heroin": {(localize "STR_License_Heroin")};
	case "license_reb_lsd": {(localize "STR_License_LSD")};	
