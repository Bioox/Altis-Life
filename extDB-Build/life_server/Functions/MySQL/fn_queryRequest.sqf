...
_query = switch(_side) do {
	...
	case east: {_returnCount = 10; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, reb_licenses, arrested, rebellevel, reb_gear FROM players WHERE playerid='%1'",_uid];};
};
